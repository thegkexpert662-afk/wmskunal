  ...
  Widget build(BuildContext context) => MaterialApp(
        ...
        theme: ThemeData(
          ...
          colorScheme: ColorScheme.fromSeed(
            seedColor: const Color(0xFF0B9ACB),
          ),
        ),
...
class _DashboardState extends State<Dashboard> {
          ...
          Expanded(
            child: Column(
              children: [
                _topbar(mobile),
                Expanded(
                  child: selected == 0 ? _dashboard() : _module(),
                ),
              ],
            ),
          ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [Color(0xFF09A2D3), Color(0xFF116FA3)],
                      ),
  ...
  Widget _menu() => ListView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          return ListTile(
            dense: true,
            selected: active,
            selectedTileColor: const Color(0xFFE6F6FC),
            ...
            title: collapsed
                ...
                : Text(
                    ...
                    style: TextStyle(
                      ...
                      color: active
                          ? const Color(0xFF08739F)
                          : const Color(0xFF435A65),
                    ),
                  ),
            onTap: () {
              setState(() => selected = i);
  ...
  Widget _topbar(bool mobile) => Container(
        ...
        decoration: const BoxDecoration(
          color: Colors.white,
          border: Border(
            bottom: BorderSide(color: Color(0xFFE1EDF2)),
          ),
        ),
        child: Row(
          children: [
  ...
  Widget _dashboard() => LayoutBuilder(
        builder: (_, c) => SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Warehouse activity overview for today.',
                style: TextStyle(color: Color(0xFF6C818B)),
              ),
              ...
              GridView.count(
                ...
                children: [
                  _stat('Total Clients', '24', Icons.business_outlined),
                  _stat('Warehouses', '08', Icons.warehouse_outlined),
                  _stat('Today Inbound', '128', Icons.move_to_inbox_outlined),
                  _stat('Today Outbound', '96', Icons.local_shipping_outlined),
                ],
              ),
              const SizedBox(height: 24),
              c.maxWidth < 1000
  ...
  Widget _operations() => Column(
        ...
        children: [
          ...
          Card(
            child: Column(
              children: [
                _row('Inbound / GRN', '128', Icons.move_to_inbox_outlined),
                _row('Pending Orders', '42', Icons.shopping_cart_outlined),
                _row('Picking', '31', Icons.playlist_add_check_outlined),
  ...
  Widget _row(String title, String value, IconData icon) => ListTile(
  ...
  Widget _orders() => Column(
        ...
        children: [
          ...
          Card(
            child: Column(
              children: [
                _order('ORD-10284', 'ABC Industries', 'Processing'),
                _order('ORD-10283', 'Metro Retail', 'Picking'),
                _order('ORD-10282', 'Prime Traders', 'Dispatched'),
                _order('ORD-10281', 'Global Parts', 'Pending'),
              ],
            ),
          ),
        ],
  ...
  Widget _order(String id, String client, String status) => ListTile(
        leading: const Icon(
  ...
  Widget _inventory() => Card(
        child: Padding(
          ...
          child: Wrap(
            ...
            runSpacing: 18,
            children: const [
              _Mini('12,840', 'Stock Items'),
              _Mini('16', 'Low Stock'),
              _Mini('09', 'On Hold'),
              _Mini('24', 'Total Clients'),
            ],
          ),
        ),
      );

  Widget _module() => Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(
              menu[selected]['icon'] as IconData,
              size: 70,
              color: const Color(0xFF0B8DBB),
            ),
            ...
            const Text(
              'Module UI will be developed next.',
              style: TextStyle(color: Color(0xFF71858E)),
            ),
          ],
        ),
      );
