          ...
          HorizontalTableScroller(
            child: DataTable(
              ...
              columns: const [
                ...
                DataColumn(columnWidth: const FixedColumnWidth(110), label: Text('Client ID')),
                DataColumn(columnWidth: const FixedColumnWidth(170), label: Text('Client Name')),
                DataColumn(columnWidth: const FixedColumnWidth(120), label: Text('Brand')),
                DataColumn(columnWidth: const FixedColumnWidth(140), label: Text('Warehouse')),
                DataColumn(columnWidth: const FixedColumnWidth(145), label: Text('Contact Person')),
                DataColumn(columnWidth: const FixedColumnWidth(75), label: Text('Email')),
                DataColumn(columnWidth: const FixedColumnWidth(75), label: Text('Orders')),
                DataColumn(columnWidth: const FixedColumnWidth(105), label: Text('Status')),
                DataColumn(columnWidth: const FixedColumnWidth(100), label: Text('Billing')),
