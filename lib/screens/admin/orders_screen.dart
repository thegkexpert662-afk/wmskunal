          ...
          HorizontalTableScroller(
            child: DataTable(
              ...
              columns: const [
                ...
                DataColumn(columnWidth: const FixedColumnWidth(95), label: Text('Order Date')),
                DataColumn(columnWidth: const FixedColumnWidth(95), label: Text('Required')),
                DataColumn(columnWidth: const FixedColumnWidth(105), label: Text('Status')),
                DataColumn(columnWidth: const FixedColumnWidth(115), label: Text('Order Value')),
