...
class _AdminPutawayScreenState extends State<AdminPutawayScreen> {
  ...
  Widget _table(List<Map<String, dynamic>> rows) => Container(decoration: _box(), child: Column(children: [
    ...
    SingleChildScrollView(scrollDirection: Axis.horizontal, child: DataTable(
      ...
      columns: const [DataColumn(columnWidth: const FixedColumnWidth(50), label: Text('#')),DataColumn(columnWidth: const FixedColumnWidth(110), label: Text('PUT No.')),DataColumn(columnWidth: const FixedColumnWidth(110), label: Text('GRN No.')),DataColumn(columnWidth: const FixedColumnWidth(170), label: Text('Product / SKU')),DataColumn(columnWidth: const FixedColumnWidth(75), label: Text('Qty')),DataColumn(columnWidth: const FixedColumnWidth(140), label: Text('Warehouse')),DataColumn(columnWidth: const FixedColumnWidth(95), label: Text('Zone')),DataColumn(columnWidth: const FixedColumnWidth(95), label: Text('Bin')),DataColumn(columnWidth: const FixedColumnWidth(105), label: Text('Status')),DataColumn(columnWidth: const FixedColumnWidth(90), label: Text('Action'))],
