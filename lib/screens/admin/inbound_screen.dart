          ...
          SingleChildScrollView(
            ...
            child: DataTable(
              ...
              columns: const [
                ...
                DataColumn(columnWidth: const FixedColumnWidth(110), label: Text('GRN No.')),
                DataColumn(columnWidth: const FixedColumnWidth(95), label: Text('GRN Date')),
                DataColumn(columnWidth: const FixedColumnWidth(170), label: Text('Supplier')),
                ...
                DataColumn(columnWidth: const FixedColumnWidth(75), label: Text('Items')),
                DataColumn(columnWidth: const FixedColumnWidth(105), label: Text('Total Qty')),
                DataColumn(columnWidth: const FixedColumnWidth(115), label: Text('Total Value')),
