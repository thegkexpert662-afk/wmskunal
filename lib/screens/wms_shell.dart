        ...
        children: [
          ...
          if (!collapsed)
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFF0B2B50),
                borderRadius: BorderRadius.circular(10),
                border: Border.all(color: const Color(0xFF1C4168)),
              ),
              child: const Row(
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Need Help?', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 12)),
                      SizedBox(height: 3),
                      Text('Contact Support', style: TextStyle(color: Color(0xFF2F8CFF), fontSize: 11)),
                    ],
                  ),
                ],
              ),
      ...
      child: Row(
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                if (!mobile)
                  Row(
                    children: [
                      const Text('Dashboard', style: TextStyle(color: Color(0xFF66788E), fontSize: 12)),
                      const Padding(
                        padding: EdgeInsets.symmetric(horizontal: 7),
                        child: Icon(Icons.chevron_right, size: 15, color: Color(0xFF9AA8B8)),
                      ),
                      Text(title, style: const TextStyle(color: Color(0xFF1769D5), fontSize: 12, fontWeight: FontWeight.w600)),
                    ],
                  ),
              ],
            ),
          ...
          IconButton(
            ...
            icon: const Icon(Icons.notifications_none_rounded, color: Color(0xFF263B54)),
          ),
          ...
          PopupMenuButton<String>(
            ...
            child: const CircleAvatar(
              ...
              child: Icon(Icons.person, color: Color(0xFF1769D5)),
            ),
          ),
          if (!mobile)
            const Padding(
              ...
              child: Column(
                ...
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text('Admin User', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 13, color: Color(0xFF1A2C43))),
                  SizedBox(height: 2),
                  Text('Administrator', style: TextStyle(fontSize: 11, color: Color(0xFF718198))),
                ],
              ),
            ),
          if (!mobile)
            const Icon(Icons.keyboard_arrow_down, color: Color(0xFF52657A)),
        ],
      ),
    );
  }
